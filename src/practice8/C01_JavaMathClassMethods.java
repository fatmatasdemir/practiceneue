...
public class C01_JavaMathClassMethods {
    ...
    public static void main(String[] args) {
        ...
        // 3.5 altinda olursa ornek 3 tamamlanir ama 3,6 ustu ise yuvarlama 4 olur
  ...
  // floor kullanirsak 3,1 veya 3,5 alt tamsayiya yuvarla diyince  -----> 3 yuvarlar
        ...
        // Java Math.Random Kullanimi  // 0 ile 1 arasi sayi uretir
        for(int adet = 0; adet< 10; adet++){
            System.out.println("Java Math.Random Sayi: " + Math.random());
        }// rastgele 10 tane random yazdirdik 0 ile basladi




        //java.util.Random Kullanimi // burada araligi biz belirliyoruz
