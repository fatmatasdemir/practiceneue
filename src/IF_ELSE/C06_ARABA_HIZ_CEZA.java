...
public class C06_ARABA_HIZ_CEZA {
     ...
     */
        ...
        if (ehliyetiniz == 0 || ehliyetiniz == 1) {//ehlivetin varlık yokluk sartına göre diger kosullar çalışacak
            ...
            if (ehliyetiniz == 1) {
                ...
                } else System.out.println("hız sınırında seyahat ediyorsunuz ancak ehliyetsiz olmadigi için cezanız 200$");

            } else System.out.println("agam  ehliyet var mı yoooh mu?");
        } else
            System.out.println("agam bizimle eglenir ehliyet var mı yooh mu :)");//ehliyet verisinin hatalı olmasi kontrolu
    }
